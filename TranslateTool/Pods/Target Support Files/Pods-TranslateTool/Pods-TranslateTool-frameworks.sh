...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "Pods-TranslateTool/Appirater.framework"
  install_framework "Pods-TranslateTool/CocoaLumberjack.framework"
  ...
  install_framework "Pods-TranslateTool/SVProgressHUD.framework"
